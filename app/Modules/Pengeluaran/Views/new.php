                        ...
                        <div class="card-body">
                            ...
                            <form action="/pengeluaran/create" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tgl_pengeluaran" class="form-control datepicker" name="tgl_pengeluaran" value="<?= old('tgl_pengeluaran'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="catatan" id="catatan" cols="30" rows="10" class="form-control <?= $validation->hasError('catatan') ? 'is-invalid' : null ?>"><?= old('catatan'); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="pengeluaran" class="form-control <?= $validation->hasError('pengeluaran') ? 'is-invalid' : null ?>" name="pengeluaran" value="<?= old('pengeluaran'); ?>">
