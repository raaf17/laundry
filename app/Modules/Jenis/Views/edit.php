                        ...
                        <div class="card-body">
                            ...
                            <form class="form" action="/jenis/update/<?= $data_jenis->id_jenis; ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="jenis_laundry" class="form-control" name="jenis_laundry" value="<?= $data_jenis->jenis_laundry; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="lama_proses" class="form-control" name="lama_proses" value="<?= $data_jenis->lama_proses; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="tarif" class="form-control" name="tarif" value="<?= $data_jenis->tarif; ?>">
                                    <div class="invalid-feedback">
