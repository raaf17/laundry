            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="/users/restore" class="btn btn-info">Restore All</a>
                        <form action="/users/delete3" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
                            <?= csrf_field(); ?>
                            ...
                            <?php foreach ($data_user as $data) : ?>
                                <tr>
                                    ...
                                    <td width="18%" class="text-center">
                                        <a href="/users/restore/<?= $data->id_user; ?>" class="btn btn-info btn-sm">Restore</a>
                                        <form action="/users/delete2/<?= $data->id_user; ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
                                            <?= csrf_field(); ?>
