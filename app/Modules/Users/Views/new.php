                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="username" class="form-control <?= $validation->hasError('username') ? 'is-invalid' : null ?>" name="username" value="<?= old('username'); ?>">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" class="form-control <?= $validation->hasError('password') ? 'is-invalid' : null ?>" name="password" value="<?= old('password'); ?>">
